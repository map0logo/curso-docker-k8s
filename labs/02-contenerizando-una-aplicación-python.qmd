---
title: "Taller de Docker: Contenerización de Aplicación Python"
format: html
engine: knitr
---
...
- Crear una aplicación web simple con FastAPI
- Escribir y optimizar Dockerfiles para aplicaciones Python
- Implementar multi-stage builds para reducir tamaño de imágenes
- Aplicar mejores prácticas de seguridad y eficiencia
- Utilizar herramientas de análisis y optimización
...
## 1. Crear Aplicación FastAPI "Hola Mundo"
...
Dentro de esta carpeta `mi-app-fastapi`, crearemos un archivo donde se hospedara el codigo de la aplicación, llamado `main.py`.
...
Mediante el cual se puede instalar la aplicación dentro de la imagén Docker.

### Ejercicio de Exploración: Probar la Aplicación Localmente
...
## 2. Dockerfile Básico para FastAPI

### Versión Inicial (Dockerfile.basic)

```dockerfile{eval=False}
# Dockerfile básico - Versión inicial
FROM python:3.13.3
...
### Construir y Probar la Imagen Básica
...
### Versión Mejorada (`Dockerfile.optimized`)
...
### 🔍 Ejercicio de Exploración: Comparar Tamaños
...
Con un archivo .dockerignore, podemos excluir archivos del contexto de build para hacer imágenes más ligeras:
...
### Optimización Extrema (`Dockerfile.ultraoptimized`)
...
## 4. Scripts de Automatización y Validación
...
### Script de Construcción (`validate.py`)
...
1. ¿Qué ventajas tiene usar `python:3.11-slim` sobre `python:3.11`?

2. ¿Por qué es importante crear un usuario no-root en el contenedor?

3. ¿Cómo ayuda el multi-stage build a reducir el tamaño de la imagen final?

### Troubleshooting

4. Si tu contenedor se inicia pero no responde en el puerto 8000, ¿qué pasos seguirías para diagnosticar el problema?

5. ¿Cómo verificarías qué capas están contribuyendo más al tamaño de tu imagen?

### Optimización

6. ¿Qué elementos deberías incluir en tu archivo `.dockerignore` para una aplicación Python?

7. ¿Cómo implementarías un health check efectivo para tu aplicación FastAPI?

### Aplicación Práctica

8. ¿Qué cambios harías en el Dockerfile si necesitaras conectarte a una base de datos PostgreSQL?

9. ¿Cómo manejarías variables de entorno sensibles como contraseñas de base de datos?
