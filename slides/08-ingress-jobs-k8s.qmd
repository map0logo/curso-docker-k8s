...
**2. Ingress Resource:** La "configuración" con las reglas de enrutamiento
...
::: {.columns}
::: {.column width="60%}
**Problema:** ¿Y las tareas que no son servicios continuos?
...
- Limita tráfico con network policies
- Considera WAF (Web Application Firewall)

**Configuración:**
- Annotations específicas del controller
- Timeouts apropiados para tu aplicación
...
**Próximo:** Laboratorio práctico configurando Ingress para múltiples aplicaciones y automatizando tareas con CronJobs.